...
<div class="w-full max-w-sm border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 bg-pink-200">
    <Link to="#">
        <img class="p-8 rounded-t-lg" src={cake} alt="product" />
    </Link>
    <div class="px-5 pb-5">
        <Link to="#">
        ...
        <div class="flex items-center justify-between">
            ...
            <Link to="#" class="text-white bg-pink-500 hover:bg-pink-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</Link>
        </div>
    </div>
</div> 
...
<div class="w-full max-w-sm border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 bg-pink-200">
    ...
    <div class="px-5 pb-5">
        ...
        <div class="flex items-center justify-between">
            <span class="text-3xl font-bold text-gray-900 dark:text-white">$599</span>
            <Link to="#" class="text-white bg-pink-500 hover:bg-pink-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add to cart</Link>
        </div>
    </div>
</div>
