...
<div
       className="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-3xl max-w-6xl mx-auto bg-pink-200 mt-4 font-[sans-serif] before:absolute before:right-0 before:w-[300px] before:bg-pink-500 before:h-full max-md:before:hidden">
            <div >
                ...
                <form>
                    <div className="space-y-4 mt-8">
                        ...
                        <textarea placeholder="Write Message"
                            className="px-2 pt-3 bg-white w-full text-gray-800 text-sm border-b border-gray-300 focus:border-pink-500 outline-none"></textarea>
                    </div>
            ...
            <div className="z-10 relative h-full max-md:min-h-[350px]">
                <iframe src="https://maps.google.com/maps?q=manhatan&t=&z=13&ie=UTF8&iwloc=&output=embed"
                    className="left-0 top-0 h-full w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg" frameborder="0" title='Map'
