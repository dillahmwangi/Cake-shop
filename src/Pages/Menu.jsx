...
const Sidebar = () => {
    ...
    const nestedNav = [{ name: "Cards", href: "#", icon: "" }, { name: "Chekouts", href: "#", icon: "" }, { name: "Payments", href: "#", icon: "" }, { name: "Get paid", href: "#", icon: "" }]
                ...
                <div class="flex flex-col h-full px-4">
                    <div className='h-20 flex items-center pl-2'>
                        <div className="w-full flex items-center gap-x-4">
                            <img src="https://randomuser.me/api/portraits/women/79.jpg" className="w-10 h-10 rounded-full" alt=""/>
                            <div>
                                    ...
                                    isProfileActive ? (
                                        <div className="absolute z-10 top-12 right-0 w-64 rounded-lg bg-white shadow-md border text-sm text-gray-600">
                                            <div className="p-2 text-left">
                                                ...
                                                <Link to="#" className="block w-full p-2 text-left rounded-md hover:bg-gray-50 active:bg-gray-100 duration-150">
                                                    Add another account
                                                </Link>
