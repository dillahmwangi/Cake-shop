...
<div class="font-sans bg-pink-200 p-4">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="mt-12">
            ...
            <div class="md:col-span-2">
              ...
              <div class="flex items-center">
                  ...
                  <label for="paypal" class="ml-4 flex gap-2 cursor-pointer">
                    <img src="https://images.app.goo.gl/A59Z9PkprPPak48CA" class="w-20" alt="M-pesa" />
                  </label>
                </div>
          ...
          <div class="flex flex-wrap justify-end gap-4 mt-12">
            <button type="button"
              class="px-6 py-3 text-sm font-semibold tracking-wide bg-transparent border-2 border-pink-500 text-gray-800 rounded-md hover:bg-pink-300">Pay later</button>
            <button type="button"
              class="px-6 py-3 text-sm font-semibold tracking-wide bg-pink-500 text-white rounded-md hover:bg-pink-600">Pay now</button>
          </div>
        </div>
      </div>
    </div>
