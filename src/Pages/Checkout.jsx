...
<form class="font-[sans-serif] max-w-4xl mx-auto bg-pink-200 p-5 rounded-xl">
      <div class="grid sm:grid-cols-2 gap-8">
        <div class="relative">
          <div class="relative flex items-center">
            <input type="text" placeholder="First Name"
              class="px-2 py-3 bg-white text-black w-full text-sm border-b-2 focus:border-pink-500 outline-none" />
          ...
          <p class="hidden absolute -bottom-5 px-2 text-xs text-pink-500">This fields is required!</p>
        </div>
        ...
        <div class="relative">
          <div class="relative flex items-center">
            <input type="number" placeholder="Phone No."
              class="px-2 py-3 bg-white text-black w-full text-sm border-b-2 border-pink-500 focus:border-pink-500 outline-none" />
          ...
          <p class="absolute -bottom-5 px-2 text-xs text-pink-500">This number is already exist!</p>
        </div>
        ...
        <div class="relative sm:col-span-2">
          <div class="relative flex items-center">
            <input type="email" placeholder="Email"
              class="px-2 py-3 bg-white text-black w-full text-sm border-b-2 border-red-500 focus:border-pink-500 outline-none" />
            <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] absolute right-2"
        ...
        <div class="relative sm:col-span-2">
          <div class="relative flex items-center">
            <input type="password" placeholder="Password" autocomplete="new-password"
              class="px-2 py-3 bg-white text-black w-full text-sm border-b-2 focus:border-pink-500 outline-none" />
            <svg xmlns="http://www.w3.org/2000/svg" fill="fill-gray-800" stroke="#bbb"
      ...
      <button type="button"
        class="mt-8 px-8 py-3 rounded-md mx-auto block text-sm bg-pink-500 text-white hover:bg-pink-600 ">Submit</button>
    </form>
