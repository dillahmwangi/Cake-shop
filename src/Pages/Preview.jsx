            ...
            <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-10">
                <div className="space-y-4 text-center lg:sticky top-10">
                    <div className="bg-gray-100 p-4 flex items-center sm:h-[380px] rounded-lg">
                        <img src={cake} alt="Product" className="w-full max-h-full object-contain object-top" />
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="bg-gray-100 p-4 flex items-center rounded-lg sm:h-[182px]">
                            <img src={cake3} alt="Product" className="w-full max-h-full object-contain object-top" />
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-md">
                    ...
                    <div className="flex space-x-1 mt-4">
                        <svg className="w-5 fill-pink-500" viewBox="0 0 14 13" fill="none"
                        ...
                        <button type="button" className="px-2.5 py-1.5 bg-gray-100 text-xs text-gray-800 rounded-lg flex items-center !ml-4">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="flex flex-wrap gap-4 mt-4">
                            <button type="button" className="w-10 h-10 border hover:border-pink-500 font-semibold text-sm rounded-lg flex items-center justify-center shrink-0">SM</button>
                            <button type="button" className="w-10 h-10 border hover:border-pink-500 border-pink-500 font-semibold text-sm rounded-lg flex items-center justify-center shrink-0">MD</button>
                            <button type="button" className="w-10 h-10 border hover:border-pink-500 font-semibold text-sm rounded-lg flex items-center justify-center shrink-0">LG</button>
                            <button type="button" className="w-10 h-10 border hover:border-pink-500 font-semibold text-sm rounded-lg flex items-center justify-center shrink-0">XL</button>
                        </div>
                    </div>

                    <div className="flex flex-wrap gap-4 mt-8">
                        <button type="button" className="min-w-[200px] px-4 py-3 bg-pink-500 hover:bg-pink-500 text-white text-sm font-semibold rounded-lg">Buy now</button>
                        <button type="button" className="min-w-[200px] px-4 py-2.5 border border-pink-500 bg-transparent hover:bg-pink-500 text-gray-800 text-sm font-semibold rounded-lg">Add to cart</button>
                    </div>

                    <div className="mt-8">
                        <ul className="flex border-b">
                            <li
                                className="text-gray-800 font-bold text-sm bg-gray-100 py-3 px-8 border-b-2 border-pink-500 cursor-pointer transition-all">
                                Description</li>
