...
const Gallery = () => {
  ...
  const products = [
    { name: 'Espresso Elegante', price: '$10', img: cake },
    { name: 'Mocha Madness', price: '$12', img: cake3 },
  ...
  return (
    ...
    {products.map((product) => (
      <div key={product.id} className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
        ...
        <div className="text-center bg-gray-100 p-6">
          ...
          <h4 className="text-lg text-gray-800 font-bold mt-6">{product.price}
          </h4>
          <button 
    ...
    {isOpen && <Preview product={selectedProduct} onClose={closeModal} />}
</div>
